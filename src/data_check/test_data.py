...
def test_row_count(data: pd.DataFrame) -> None:
    """
    Test if the DataFrame has a reasonable number of rows (over 15,000 and under 1,000,000).

    Args:
    data: Current dataset to test

    Raises:
        AssertionError: If the number of rows is not within the specified range.
    """
